...
+ **Five years [Interbase](http://www.embarcadero.com/products/interbase)** and **[Firebird](http://www.firebirdsql.org/)** experience.
...
reconciliation. Employed sophisticated workflow mechanism. Size: 160,000 Lines of Code (700
forms), Delphi 5. Developed over three years.
+ Designed and developed SimplePop, a multi-user purchase ordering system which used
...
web and desktop solutions. My clients included:
...
project management procedures. Developed high-availability services that processed HL7 messages
for various health care applications that interfaced to Samsung and HP medical equipment. Deployed in several NHS Trusts.
...
+ [Diablo 2](https://en.wikipedia.org/wiki/Diablo_II) - a serious multiplayer time vampire.
